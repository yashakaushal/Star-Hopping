    ...
    ClickInfo.prototype.draw = function(){
        for(var i=0; i<this.props.id.length; i++){
            ...
            mpld3_element.elements().on("mousedown",
                              function(d, i){var firstbox = document.getElementById('firstbox');
                                                hops_list=hops_list+ "  " +d ; console.log(hops_list);
                                                alert("Hop-Stored");
                                                firstbox.innerHTML = "Your Chosen RA/DEC is: " + d;}
                              );
        }                   
    }  
    """
...
# scatter messier
    ...
    flux = 10**(-mag/2.5)
    p1 = ax.scatter(cl_ms['RAJ2000'],cl_ms['DEJ2000'],color='darkorange',s = 50*flux, zorder=10, edgecolor="black")
    ...
    flux = 10**(-mag/2.5)
    p2 = ax.scatter(pn_ms['RAJ2000'],pn_ms['DEJ2000'],color='white',s= 1e2*flux, zorder=0)
    ...
    flux = 10**(-mag/2.5)
    p3 = ax.scatter(ga_ms['RAJ2000'],ga_ms['DEJ2000'],color='red',s= 50*flux ,zorder=20,alpha=1, edgecolor="black")
    ...
    flux = 10**(-mag/2.5)
    p4 = ax.scatter(re_ms['RAJ2000'],re_ms['DEJ2000'],c='white',s= 1e2*flux)
...
# scatter ngc
    ...
    flux = 10**(-mag/2.5)
    p5 = ax.scatter(mag_ng['_RAJ2000'], mag_ng['_DEJ2000'], c='white',alpha=0.8,s= 1e2*flux)
...
# scatter tycho
    ...
    flux = 10**(-mag/2.5)
    p6 = ax.scatter(mag_ty['_RAJ2000'], mag_ty['_DEJ2000'], c='white', s= 1e2*flux)
